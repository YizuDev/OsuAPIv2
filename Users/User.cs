...
namespace OsuAPIv2.Users
{
    ...
    public class User
    {
        ...
        public class UsersData
        {
            ...
            [JsonProperty("profile_colour")] public object ProfileColour { get; set; }
            ...
            [JsonProperty("kudosu")] public Kudosu Kudosu { get; set; }
            ...
            [JsonProperty("title_url")] public object TitleUrl { get; set; }

            [JsonProperty("twitter")] public object Twitter { get; set; }
            ...
            [JsonProperty("account_history")] public List<object> AccountHistory { get; set; }
            ...
            [JsonProperty("rankHistory")] public RankHistory RankHistory { get; set; }

            [JsonProperty("rank_history")] public RankHistory Rank_History { get; set; }
